      ...
      <div className="container-custom px-4 relative z-10">
        ...
        <div className="mb-16">
          <div className="relative w-full max-w-5xl mx-auto">
            ...
            <div className="relative h-80 bg-gradient-to-br from-slate-900/90 to-slate-800/90 rounded-3xl shadow-2xl border border-blue-400/20 overflow-hidden">
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-30">
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-500/20 rounded-full border border-blue-400/30">
                    ...
                    <span className="text-xs text-blue-300 font-medium">Live Network</span>
                  </div>
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-cyan-500/20 rounded-full border border-cyan-400/30">
                    <div className="w-1.5 h-1.5 bg-cyan-400 rounded-full animate-pulse"></div>
                    <span className="text-xs text-cyan-300 font-medium">Real-time</span>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-lg font-bold text-white">Global Trade Network</div>
                  <div className="text-xs text-slate-300">Powered by CargoTrace</div>
                </div>
              </div>

              {/* Trading Hubs - Cleaner Layout */}
              <div className="absolute inset-0 flex items-center justify-center pt-16 pb-20">
                ...
                <div className="relative z-20">
                  ...
                  <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-center">
                    <div className="text-xs text-blue-300 font-bold">Dubai</div>
                    <div className="text-xs text-slate-400">Central Hub</div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-8 right-16 z-20">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-cyan-400 rounded-full flex items-center justify-center shadow-xl shadow-orange-500/50 animate-pulse" style={{animationDelay: '3s'}}>
                    <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
              ...
              <div className="absolute inset-0 z-10 pt-16 pb-20">
                {/* Route 1: Dubai to Singapore */}
                <div className="absolute top-1/2 left-1/2 w-24 h-0.5 bg-gradient-to-r from-blue-400/60 via-cyan-400/40 to-transparent transform rotate-45 origin-left animate-pulse"></div>
                
                {/* Route 2: Dubai to Rotterdam */}
                <div className="absolute top-1/2 left-1/2 w-24 h-0.5 bg-gradient-to-r from-blue-400/60 via-indigo-400/40 to-transparent transform -rotate-45 origin-left animate-pulse" style={{animationDelay: '1s'}}></div>
                
                {/* Route 3: Dubai to Mumbai */}
                <div className="absolute top-1/2 left-1/2 w-28 h-0.5 bg-gradient-to-r from-blue-400/60 via-orange-400/40 to-transparent transform -rotate-12 origin-left animate-pulse" style={{animationDelay: '2s'}}></div>
              </div>

              {/* Floating Cargo Ships - Reduced */}
              <div className="absolute inset-0 z-15 pt-16 pb-20">
                <div className="absolute top-1/3 left-1/4 w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-lg transform rotate-12 animate-float shadow-lg">
                  <div className="w-full h-full flex items-center justify-center text-white text-xs">🚢</div>
                </div>
                <div className="absolute top-1/2 right-1/4 w-8 h-8 bg-gradient-to-br from-cyan-500 to-blue-400 rounded-lg transform -rotate-12 animate-float shadow-lg" style={{animationDelay: '2s'}}>
                  <div className="w-full h-full flex items-center justify-center text-white text-xs">🚢</div>
                </div>
                <div className="absolute bottom-1/3 left-1/3 w-8 h-8 bg-gradient-to-br from-indigo-500 to-blue-400 rounded-lg transform rotate-45 animate-float shadow-lg" style={{animationDelay: '4s'}}>
                  <div className="w-full h-full flex items-center justify-center text-white text-xs">🚢</div>
                </div>
              </div>

              {/* Statistics Panel - Moved to bottom */}
              <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center z-30">
                ...
                <div className="text-right">
                  <div className="text-xs text-slate-300">Live Transactions</div>
                  <div className="text-sm font-bold text-green-400">1,247</div>
                </div>
              </div>

              {/* Overlay Gradient */}
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/50 via-transparent to-slate-900/30 pointer-events-none z-5"></div>
            </div>
          </div>
        </div>
